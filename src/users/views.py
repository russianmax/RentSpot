...
def profile(request):
    if request.method == 'POST':
        ...
        p_form = ProfileUpdateForm(request.POST, request.FILES, instance=request.user.landlord_profile)
        ...
        p_form = ProfileUpdateForm(instance=request.user.landlord_profile)
